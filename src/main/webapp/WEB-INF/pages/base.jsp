...
<title>jDebitor - Dashboard</title>
...
<link href="<c:url value='/assets/css/bootstrap-table.css'/>" rel="stylesheet">
...
<body>
	<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="#"><span>jDebitor</span> Customer View</a>
				<ul class="user-menu">
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			<li class="active"><a href="<c:url value='/'/>"><span class="glyphicon glyphicon-dashboard"></span> Dashboard</a></li>
			<li><a href="<c:url value='/customer/'/>"><span class="glyphicon glyphicon-list-alt"></span> Customers</a></li>
			<li><a href="charts.html"><span class="glyphicon glyphicon-stats"></span>Invoices</a></li>
	...
	<script src="<c:url value='/assets/js/chart-data.js'/>"></script>
